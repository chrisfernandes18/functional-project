...
var $author$project$Structs$LL = F2(
	function (a, b) {
		return {$: 'LL', a: a, b: b};
	});
var $author$project$Structs$Piece = F3(
	function (a, b, c) {
		return {$: 'Piece', a: a, b: b, c: c};
	});
var $author$project$Logic$newTile = F3(
	function (color, row, col) {
		if (color.$ === 'Nothing') {
			...
			return A3(
				...
				c,
				A2($author$project$Structs$LL, row, col),
				(row < 3) ? $author$project$Structs$Inc : $author$project$Structs$Dec);
		}
	});
var $author$project$Logic$newBoard = function (i) {
	var res = A2(
		$elm$core$Array$initialize,
		i,
		function (rowInd) {
			var rowEven = A2($elm$core$Basics$modBy, 2, rowInd);
			return ((rowInd === 3) || (rowInd === 4)) ? A2(
				$elm$core$Array$initialize,
				i,
				function (_v0) {
					return $author$project$Structs$E;
				...
				i,
				function (colInd) {
					var colEven = A2($elm$core$Basics$modBy, 2, colInd);
					return (rowInd < 3) ? ((!colEven) ? A3($author$project$Logic$newTile, $elm$core$Maybe$Nothing, rowInd, colInd) : A3(
						$author$project$Logic$newTile,
						$elm$core$Maybe$Just($author$project$Structs$B),
						rowInd,
						colInd)) : ((!colEven) ? A3($author$project$Logic$newTile, $elm$core$Maybe$Nothing, rowInd, colInd) : A3(
						$author$project$Logic$newTile,
						$elm$core$Maybe$Just($author$project$Structs$R),
						rowInd,
						colInd));
				}) : A2(
				$elm$core$Array$initialize,
				...
				function (colInd) {
					var colEven = A2($elm$core$Basics$modBy, 2, colInd);
					return (rowInd < 3) ? ((!colEven) ? A3(
						$author$project$Logic$newTile,
						$elm$core$Maybe$Just($author$project$Structs$B),
						rowInd,
						colInd) : A3($author$project$Logic$newTile, $elm$core$Maybe$Nothing, rowInd, colInd)) : ((!colEven) ? A3(
						$author$project$Logic$newTile,
						$elm$core$Maybe$Just($author$project$Structs$R),
						rowInd,
						colInd) : A3($author$project$Logic$newTile, $elm$core$Maybe$Nothing, rowInd, colInd));
				}));
		});
	return res;
};
...
var $author$project$Render$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Render$initModel,
...
var $author$project$Render$subscriptions = function (_v0) {
		...
		_List_fromArray(
			[
				...
				A2(
					...
					function (point) {
						return $author$project$Render$Click(point);
					},
					A3(
...
var $author$project$Logic$boardRef = F2(
	function (c, _v0) {
		var row = _v0.a;
		var col = _v0.b;
		var b = c.a;
		var arr = b.a;
		var _v3 = A2($elm$core$Array$get, row, arr);
		if (_v3.$ === 'Nothing') {
			return $author$project$Structs$E;
		} else {
			var arrRow = _v3.a;
			var _v4 = A2($elm$core$Array$get, col, arrRow);
			if (_v4.$ === 'Nothing') {
				return $author$project$Structs$E;
			} else {
				var t = _v4.a;
						...
						switch (_v0.a.c.$) {
							case 'Inc':
								if (_v0.b.c.$ === 'Inc') {
									...
									var c2 = _v7.b;
									var _v8 = _v5.c;
									return _Utils_eq(r1, r2) && _Utils_eq(c1, c2);
								} else {
									break _v0$6;
								}
							case 'Dec':
...
var $author$project$Logic$getDecLL = F2(
	function (r, c) {
		var decRight = A2($author$project$Structs$LL, r - 1, c + 1);
		var decLeft = A2($author$project$Structs$LL, r - 1, c - 1);
		var capDecRight = A2($author$project$Structs$LL, r - 2, c + 2);
		var capDecLeft = A2($author$project$Structs$LL, r - 2, c - 2);
		return _List_fromArray(
			[decLeft, decRight, capDecLeft, capDecRight]);
	});
var $author$project$Logic$getIncLL = F2(
	function (r, c) {
		var incRight = A2($author$project$Structs$LL, r + 1, c + 1);
		var incLeft = A2($author$project$Structs$LL, r + 1, c - 1);
		var capIncRight = A2($author$project$Structs$LL, r + 2, c + 2);
		var capIncLeft = A2($author$project$Structs$LL, r + 2, c - 2);
		return _List_fromArray(
			[incLeft, incRight, capIncLeft, capIncRight]);
	});
var $author$project$Logic$getBothLL = F2(
	function (r, c) {
		return _Utils_ap(
...
var $author$project$Logic$checkCapture = F4(
	function (c, m, _v0, _v1) {
		...
		switch (m.$) {
			case 'Inc':
				if ((_Utils_cmp(newRow, curRow) > 0) && _Utils_eq(curRow + 2, newRow)) {
					var dif = curCol - newCol;
					var tile = A2(
					...
					var curtile = A2(
						$author$project$Logic$boardRef,
						c,
						A2($author$project$Structs$LL, curRow, curCol));
					var _v3 = _Utils_Tuple2(tile, curtile);
					_v3$3:
					while (true) {
						if (_v3.a.$ === 'E') {
							var _v4 = _v3.a;
			...
			case 'Dec':
				if ((_Utils_cmp(newRow, curRow) < 0) && _Utils_eq(curRow - 2, newRow)) {
					...
					var curtile = A2(
						...
						c,
						A2($author$project$Structs$LL, curRow, curCol));
					var _v13 = _Utils_Tuple2(tile, curtile);
					_v13$3:
					while (true) {
						if (_v13.a.$ === 'E') {
							var _v14 = _v13.a;
			...
			default:
				var incOk = (_Utils_cmp(newRow, curRow) > 0) && _Utils_eq(curRow + 2, newRow);
				var decOk = (_Utils_cmp(newRow, curRow) < 0) && _Utils_eq(curRow - 2, newRow);
				if (incOk || decOk) {
					var dif = curCol - newCol;
					var tile = A2(
						$author$project$Logic$boardRef,
					...
					var curtile = A2(
						...
						c,
						A2($author$project$Structs$LL, curRow, curCol));
					var _v23 = _Utils_Tuple2(tile, curtile);
					_v23$3:
					while (true) {
						if (_v23.a.$ === 'E') {
							var _v24 = _v23.a;
...
var $author$project$Logic$checkDirection = F3(
	function (m, _v0, _v1) {
		var curRow = _v0.a;
		var curCol = _v0.b;
		var newRow = _v1.a;
		...
		switch (m.$) {
			case 'Inc':
				return ((_Utils_cmp(newRow, curRow) > 0) && _Utils_eq(curRow + 1, newRow)) && (_Utils_eq(curCol + 1, newCol) || _Utils_eq(curCol - 1, newCol));
			case 'Dec':
				return ((_Utils_cmp(newRow, curRow) < 0) && _Utils_eq(curRow - 1, newRow)) && (_Utils_eq(curCol + 1, newCol) || _Utils_eq(curCol - 1, newCol));
			default:
...
var $author$project$Logic$legalMove = F3(
	function (c, _v0, t) {
		var newRow = _v0.a;
		var newCol = _v0.b;
		var _v1 = A2(
		...
		if (_v1.$ === 'E') {
			if (t.$ === 'E') {
				...
				var move = t.c;
				var dir = A3(
					$author$project$Logic$checkDirection,
					move,
					A2($author$project$Structs$LL, curRow, curCol),
					A2($author$project$Structs$LL, newRow, newCol));
				var cap = A4(
					$author$project$Logic$checkCapture,
					c,
					move,
					A2($author$project$Structs$LL, curRow, curCol),
					A2($author$project$Structs$LL, newRow, newCol));
				var bounds = $author$project$Logic$withinBounds(
					A2($author$project$Structs$LL, newRow, newCol));
				return (!cap) ? (dir && bounds) : bounds;
			}
		} else {
			return false;
		}
	});
var $author$project$Logic$getLegalMoves = F2(
	function (checkers, tile) {
		if (tile.$ === 'E') {
			return _List_Nil;
		} else {
			var _v1 = tile.b;
...
var $author$project$Logic$tileGivenColor = F2(
	function (t, c1) {
		if (t.$ === 'E') {
			return false;
		} else {
			var c2 = t.a;
			return A2($author$project$Logic$equalColors, c1, c2);
		}
	});
var $author$project$Logic$getPlayerTiles = F2(
	function (board, c) {
		var playerTiles = function (row) {
			return A2(
				$elm$core$Array$filter,
				function (tile) {
					return A2($author$project$Logic$tileGivenColor, tile, c);
				},
				row);
		};
		return A3(
...
var $author$project$Logic$getAllLegalMoves = function (checkers) {
	...
	var moves = function (tile) {
		return A2($author$project$Logic$getLegalMoves, checkers, tile);
	};
	return A2($elm$core$List$concatMap, moves, tiles);
};
...
var $author$project$Logic$endGame = function (checkers) {
	...
	var rowContains = function (row) {
		return !$elm$core$Array$isEmpty(
			A2($elm$core$Array$filter, currentPlayerTile, row));
	};
	var containsArr = A2($elm$core$Array$map, rowContains, board);
	return A3($elm$core$Array$foldr, $elm$core$Basics$or, false, containsArr) ? $elm$core$List$isEmpty(
		$author$project$Logic$getAllLegalMoves(checkers)) : true;
};
var $author$project$Render$gameEnded = function (model) {
	return $author$project$Logic$endGame(model.checkers) ? _Utils_update(
		model,
		{gameOver: true}) : model;
};
...
var $author$project$Structs$Both = {$: 'Both'};
var $author$project$Logic$kingMe = F2(
	function (_v0, t) {
		var newRow = _v0.a;
		var newCol = _v0.b;
		if (t.$ === 'E') {
			...
			switch (move.$) {
				case 'Inc':
					return (newRow === 7) ? A3(
						...
						color,
						A2($author$project$Structs$LL, newRow, newCol),
						$author$project$Structs$Both) : A3(
						$author$project$Structs$Piece,
						color,
						A2($author$project$Structs$LL, newRow, newCol),
						move);
...
var $author$project$Logic$movePiece = F3(
	function (c, _v0, t) {
		var newRow = _v0.a;
		var newCol = _v0.b;
		if (A3(
			$author$project$Logic$legalMove,
			c,
			A2($author$project$Structs$LL, newRow, newCol),
			t)) {
			var _v1 = _Utils_Tuple2(c, t);
			if (_v1.b.$ === 'Piece') {
				var _v2 = _v1.a;
				var _v3 = _v2.a;
				var b = _v3.a;
				...
				var move = _v4.c;
				var newPiece = A2(
					$author$project$Logic$kingMe,
					A2($author$project$Structs$LL, newRow, newCol),
					t);
				var leaveRow = function () {
					var _v8 = A2($elm$core$Array$get, curRow, b);
					if (_v8.$ === 'Nothing') {
						return $elm$core$Array$empty;
					} else {
						var lArr = _v8.a;
				...
				var deletePiece = A3($elm$core$Array$set, curCol, $author$project$Structs$E, leaveRow);
				var newBoardInter = A3($elm$core$Array$set, curRow, deletePiece, b);
				var enterRow = function () {
					var _v7 = A2($elm$core$Array$get, newRow, newBoardInter);
					if (_v7.$ === 'Nothing') {
						return $elm$core$Array$empty;
					} else {
						var eArr = _v7.a;
				...
				var addPiece = A3($elm$core$Array$set, newCol, newPiece, enterRow);
				var newBoardFinal = A3($elm$core$Array$set, newRow, addPiece, newBoardInter);
				if (A4(
					$author$project$Logic$checkCapture,
					c,
					move,
					A2($author$project$Structs$LL, curRow, curCol),
					A2($author$project$Structs$LL, newRow, newCol))) {
					var takeRow = (_Utils_cmp(newRow, curRow) > 0) ? (curRow + 1) : (curRow - 1);
					var takeBoardRow = function () {
						var _v6 = A2($elm$core$Array$get, takeRow, newBoardFinal);
						if (_v6.$ === 'Nothing') {
							return $elm$core$Array$empty;
						} else {
							var tArr = _v6.a;
					...
					var dif = curCol - newCol;
					var takeCol = (dif < 0) ? (curCol + 1) : (curCol - 1);
...
var $author$project$Logic$physicalToLogical = F2(
	function (pl, bs) {
		var _v0 = _Utils_Tuple2(pl, bs);
		var _v1 = _v0.a;
		var x = _v1.a;
		var y = _v1.b;
		var _v2 = _v0.b;
...
var $author$project$Render$wrapTile = function (t) {
	if (t.$ === 'E') {
		return $elm$core$Maybe$Nothing;
	} else {
		var c = t.a;
...
var $author$project$Render$moveTo = F3(
	function (nt, model, msg) {
		var _v0 = _Utils_Tuple2(model.checkers, msg);
		if (_v0.b.$ === 'Click') {
			var _v1 = _v0.a;
			var _v2 = _v1.a;
			var b = _v2.a;
			...
			var _v3 = _Utils_Tuple2(nt, ct);
			if (_v3.a.$ === 'Piece') {
				if (_v3.b.$ === 'Nothing') {
					var _v4 = _v3.a;
					var color = _v4.a;
					var _v5 = _v3.b;
					return A2($author$project$Logic$equalColors, color, cp) ? ctToNt : unchanged;
				} else {
					var _v6 = _v3.a;
					var color = _v6.a;
...
var $author$project$Render$playerStrToP = F3(
	function (s, name, num) {
		var _v0 = _Utils_Tuple2(s, num);
		_v0$4:
		while (true) {
			switch (_v0.a) {
				case 'human':
					switch (_v0.b) {
						...
						case 2:
							return $elm$core$Maybe$Just(
								A2($author$project$Structs$Human, name, $author$project$Structs$R));
						default:
							break _v0$4;
					}
				case 'bot':
...
var $author$project$Render$toTr = function (hs) {
...
var $author$project$Render$main = $elm$browser$Browser$element(
	{init: $author$project$Render$init, subscriptions: $author$project$Render$subscriptions, update: $author$project$Render$update, view: $author$project$Render$view});
_Platform_export({'Render':{'init':$author$project$Render$main(
